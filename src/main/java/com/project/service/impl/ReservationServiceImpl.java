...
import com.project.exception.ReservationException;
import com.project.exception.UserException;
import com.project.mapper.ReservationMapper;
import com.project.modal.Book;
import com.project.modal.Reservation;
import com.project.modal.User;
import com.project.payload.dto.ReservationDTO;
import com.project.payload.request.CheckoutRequest;
import com.project.payload.request.ReservationRequest;
import com.project.payload.request.ReservationSearchRequest;
...
public class ReservationServiceImpl implements ReservationService {
    ...
    public ReservationDTO createReservationForUser(
        ...
        log.info("Reservation created for user {} and book {} (Queue position: {})",
    ...
    public void processNextReservation(Long bookId) {
        ...
        if (nextReservationOpt.isEmpty()) {
            log.info("No pending reservations for book ID: {}", bookId);
            return;
        }
    ...
    public int expireOldReservations() {
        log.info("Starting to expire old reservations");
    ...
    private void sendAvailabilityNotification(Reservation reservation) {
        try {
            ...
            log.info("Availability notification sent to {} for book: {}", userEmail, bookTitle);
        } catch (Exception e) {
            log.error("Failed to send availability notification for reservation: {}", reservation.getId(), e);
        }
    }
}
