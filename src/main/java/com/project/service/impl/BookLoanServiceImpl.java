...
import com.project.domain.BookLoanType;
import com.project.exception.BookException;
import com.project.exception.BookLoanException;
import com.project.exception.SubscriptionException;
import com.project.exception.UserException;
import com.project.mapper.BookLoanMapper;
import com.project.modal.Book;
import com.project.modal.BookLoan;
import com.project.modal.User;
//import com.project.payload.CheckoutStatistics;
import com.project.payload.dto.BookLoanDTO;
import com.project.payload.dto.SubscriptionDto;
import com.project.payload.request.BookLoanSearchRequest;
import com.project.payload.request.CheckinRequest;
import com.project.payload.request.CheckoutRequest;
import com.project.payload.request.RenewalRequest;
import com.project.payload.response.PageResponse;
import com.project.repository.BookLoanRepository;
import com.project.repository.BookRepository;
import com.project.repository.UserRepository;
import com.project.service.BookLoanService;
//import com.project.service.FineCalculationService;
...
//        }
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.project.payload.request.UpdateBookLoanRequest updateRequest) throws BookLoanException {
        // 1. Validate book loan exists
        BookLoan bookLoan = bookLoanRepository.findById(bookLoanId)
                .orElseThrow(() -> new BookLoanException("Book loan not found with id: " + bookLoanId));
