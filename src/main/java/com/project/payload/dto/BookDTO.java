...
public class BookDTO {
    ...
    @Size(max=2000,message = "Description must knot exceed 2000 characters")
    ...
    @Digits(integer = 8,fraction = 2,message = "Price must have at most 8 integer digits and 2 fraction value")
    private BigDecimal price;

    @Size(max = 500,message = "Image URL must not exceed 500 charcters")
