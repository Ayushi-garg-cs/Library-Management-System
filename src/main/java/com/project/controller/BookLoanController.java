...
import com.project.payload.request.UpdateBookLoanRequest;
...
public class BookLoanController {
    ...
    private final Logger log = LoggerFactory.getLogger(BookLoanController.class);
    // ==================== CHECKOUT OPERATIONS ====================
...
//    }
    ...
    public ResponseEntity<?> updateBookLoan(
            ...
            @Valid @RequestBody UpdateBookLoanRequest updateRequest) {
        try {
